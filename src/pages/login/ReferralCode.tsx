    ...
    return (
        <div className=' max-w-sm mx-auto text-black bg-white h-screen' >
            <div className="flex h-full flex-col justify-center items-center w-[80%] mx-auto">
                ...
                <input type="text" onChange={(e)=> setReferral(e.target.value)} value={referral} className=' rounded-xl border-2 border-brand py-2 px-6 mt-9 w-full' placeholder='03GF6X' />
                <button onClick={handleReferralCode} className='mt-4 py-2 px-6 bg-brand hover:bg-brand/80 transition-all duration-200 text-white text-semibold rounded-xl w-full ' >Submit</button>
